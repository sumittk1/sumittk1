...
# ===========================================================================
HOST = "sumittk1"   # shown as  sumittk1@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Building practical web experiences with Python and JS"),
    ("kv", "Prev", "Shipping clean interfaces, automation, and side projects"),
    ("kv", "Also", "Exploring product-minded engineering and polished UX"),
    ("kv", "Edu", "Tech-focused learner with a builder mindset"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "Next.js, React, TypeScript"),
    ("kv", "Backend", "Python, FastAPI, Node.js"),
    ("kv", "AI / ML", "Python automation, LLM workflows, local tooling"),
    ("kv", "Cloud", "Vercel, GitHub Actions, Docker"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "I like turning rough ideas into elegant, working systems"),
    ("bul", "Clean execution, practical delivery, and constant iteration"),
]
